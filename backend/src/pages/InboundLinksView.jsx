        ...
        <div className="dashboard-page animate-fade-in">
            <div className="dashboard-header">
                <div className="dashboard-title">
                    <button className="btn btn-ghost" onClick={() => navigate(`/data-entry/${pageId}`)} style={{ marginBottom: '10px', paddingLeft: 0 }}>
                        ...
                        {links.map((link, idx) => (
                            <div key={idx} style={{
                                ...
                                <button
                                    ...
                                    onClick={() => navigate(`/data-entry/${link.sourcePageId}/${link.sourceEntryId}`)}
