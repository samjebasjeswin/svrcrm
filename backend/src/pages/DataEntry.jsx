...
export default function DataEntry() {
    ...
    const handleSave = () => {
        ...
        if (entryId) {
            ...
            if (!isSettingsPage) navigate(`/data-entry/${pageId}`);
        } else {
            ...
            if (isSettingsPage) {
                navigate(`/data-entry/${pageId}/${newEntry.id}`);
            } else {
        ...
        <>
            ...
            <div className="data-entry-header">
                <div className="data-entry-header-left">
                    <button className="back-btn" onClick={() => navigate(isSettingsPage ? '/pages' : `/data-entry/${pageId}`)}>
                        ←
                    </button>
