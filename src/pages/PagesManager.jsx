...
export default function PagesManager() {
    ...
    const setTab = (tab) => setSearchParams(tab === 'pages' ? {} : { tab });
                            ...
                            return (
                                <div key={page.id} className="card animate-fade-in-up" style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                                    ...
                                    <div style={{ display: 'flex', gap: '8px', marginTop: 'auto' }}>
                                        <button className="btn btn-primary btn-sm" style={{ flex: 1 }} onClick={() => navigate(`/data-entry/${page.id}`)}>View</button>
                                        <button className="btn btn-ghost btn-sm" onClick={() => navigate(`/edit-page/${page.id}`)}>Edit</button>
